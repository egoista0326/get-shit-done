...
description: GSD LJX research refinement
argument-hint: "[proposal or idea]"
allowed-tools:
  - Read
  - Bash
---
...
<objective>
GSD LJX research refinement. This is an Auto/ARIS research overlay command that compiles prompt, config, artifact, and evidence obligations into ordinary GSD lifecycle guidance.
</objective>
