...
description: GSD LJX novelty check
...
<objective>
GSD LJX novelty check. This is an Auto/ARIS research overlay command that compiles prompt, config, artifact, and evidence obligations into ordinary GSD lifecycle guidance.
</objective>
